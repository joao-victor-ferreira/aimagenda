...
export default function Integracao() {
  ...
  const stats = [
    { label: 'Integrações Ativas', value: '2', icon: CheckCircle, color: '#10b981' },
    { label: 'Eventos Sincronizados', value: '1.2k', icon: TrendingUp, color: '#3b82f6' },
    { label: 'Automações Ativas', value: '8', icon: Zap, color: '#f59e0b' },
    { label: 'Taxa de Sucesso', value: '98%', icon: Shield, color: '#8b5cf6' }
  ];
    ...
    <div style={styles.container}>
      ...
      <div style={styles.header}>
        <div>
          ...
          <h1 style={styles.title}>Integrações Disponíveis</h1>
          <p style={styles.subtitle}>
            Conecte suas ferramentas e deixe a AIM automatizar seus agendamentos.
          </p>
        </div>
      </div>
      ...
      <div style={styles.infoBanner}>
        ...
        <div style={styles.infoBannerContent}>
          ...
          <p style={styles.infoBannerText}>
            Conecte suas ferramentas favoritas e deixe a IA trabalhar por você. 
            Todas as integrações são seguras e criptografadas.
          </p>
        </div>
      </div>
        ...
        <div style={styles.helpCard}>
          ...
          <div>
            ...
            <p style={styles.helpText}>
              Confira nossa documentação completa sobre como configurar cada integração.
            </p>
          ...
          <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
            <div style={styles.modalHeader}>
              <div style={styles.modalTitleContainer}>
                {React.createElement(selectedIntegration.icon, { size: 32, color: selectedIntegration.color })}
                <div>
            ...
            <div style={styles.modalBody}>
              {selectedIntegration.status === 'connected' ? (
                ...
                // Disconnected state - show connect flow
                <>
                  <div style={styles.modalSection}>
                  ...
                  <div style={styles.modalSection}>
                    ...
                    <div style={styles.permissionsList}>
                      ...
                      <div style={styles.permissionItem}>
                        <Shield size={16} color="#3b82f6" />
                        <span>Acesso a informações básicas da conta</span>
                      </div>
                      <div style={styles.permissionItem}>
                        <Shield size={16} color="#3b82f6" />
                  ...
                  <div style={styles.securityNote}>
                    ...
                    <p>Todas as conexões são criptografadas e seguras. Seus dados nunca são compartilhados.</p>
                  </div>
                </>
              )}
            </div>
